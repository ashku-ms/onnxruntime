...
if(WIN32)
  ...
  set_property(TARGET mklml PROPERTY IMPORTED_LOCATION ${MKLML_EXTERNAL_LIB_DIR}/${MKLML_IMPORT_LIB})
  add_library(iomp5 STATIC IMPORTED)
  set_property(TARGET iomp5 PROPERTY IMPORTED_LOCATION ${MKLML_EXTERNAL_LIB_DIR}/${IOMP5MD_IMPORT_LIB})
else()
  ...
  set_property(TARGET mklml PROPERTY IMPORTED_LOCATION ${MKLDNN_LIB_DIR}/${MKLML_SHARED_LIB})
  add_library(iomp5 SHARED IMPORTED)
  set_property(TARGET iomp5 PROPERTY IMPORTED_LOCATION ${MKLDNN_LIB_DIR}/${IOMP5MD_SHARED_LIB})
endif()
